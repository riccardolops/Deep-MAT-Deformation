...
model = model.load_from_checkpoint("/home/rick/Documenti/Projects/models_waights/epoch=98-val_sample=48.08.ckpt", config=cfg)
trainer = pl.Trainer(accelerator="gpu", devices=[1], profiler=cfg.profiler, log_every_n_steps=cfg.eval_every, max_epochs=cfg.numb_of_epochs, default_root_dir=cfg.save_path)
